  ...
  steps: [
    {
      ...
      body: (
        <>
          <p>
            CSMP is a physical-security risk methodology built around three
            pillars: a structured <strong>asset model</strong>, a
    ...
    },
    {
      ...
      body: (
        <>
          <p>
            Every threat in CSMP is described as three independent dimensions:
          </p>
