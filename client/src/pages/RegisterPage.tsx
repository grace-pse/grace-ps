  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (/already bootstrapped/i.test(message)) {
        setError('This instance is already initialized. Use the sign-in form instead.');
        return;
      }
      setError(message);
    }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-5">
          <h1 className="text-[17px] font-semibold tracking-[-0.2px] text-n-900 mb-1">
            Set up your GRACE instance
          </h1>
          <p className="text-[11.5px] text-n-500 mb-4">
            First-run only — you become the admin for this instance.
          </p>
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            >
              {loading ? 'Setting up…' : 'Bootstrap instance'}
            </Btn2>
          </form>
