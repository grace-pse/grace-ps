  ...
  return (
    ...
    >
      <Card className="p-0 overflow-hidden">
        <div className="grid grid-cols-[140px_140px_140px_140px_160px_120px] gap-2 px-3 py-2 bg-n-50 border-b border-n-150 text-[10px] font-mono uppercase text-n-500 tracking-[0.4px]">
          <span>Type</span>
          <span>Color (border)</span>
          <span>Background</span>
          <span>Ink</span>
          <span>Icon · abbreviation</span>
          <span>Preview</span>
        </div>
        {ASSET_TYPES.map((type) => {
          ...
          return (
            <div key={type} className="grid grid-cols-[140px_140px_140px_140px_160px_120px] gap-2 items-center px-3 py-2 border-b border-n-100 last:border-b-0">
              <div className="text-[12px] font-mono text-n-800">{type}</div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <input
                  ...
                  className="w-16 h-7 px-1.5 border border-n-200 rounded-r1 text-[11.5px] font-mono text-center"
                />
              </div>
              <div className="flex items-center gap-1.5">
                <span
